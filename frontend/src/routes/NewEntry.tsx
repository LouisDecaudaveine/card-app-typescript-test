...
export default function NewEntry(){
    const emptyEntry: Entry = {title: "", description: "",scheduled_date: new Date(),created_at: new Date()}
    ...
    return(
        <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 dark:bg-zinc-900 p-8 rounded-md">
            ...
            <div >
                <p className='dark:text-gray-300'>Scheduled Date: </p>
                <input className="p-3 rounded-md w-max" type="date" name="scheduled_date" value={(new Date(newEntry.scheduled_date)).toISOString().split('T')[0]} onChange={handleInputChange} />
            </div>
            <div>
                <p className='dark:text-gray-300'>Created At: </p>
