...
export default function ThemeSwitch(props:{toggleDarkMode:(()=>void)}){

    return(
        <div className="flex flex-col justify-center m-2 hover "  onClick={props.toggleDarkMode}>
            <input type="checkbox" name="light-switch" className="light-switch sr-only"/>
            <label className=" cursor-pointer block m-auto rounded-md p-1 border-2 dark:border-slate-900 hover:bg-slate-100 dark:hover:bg-slate-900" htmlFor="light-switch">
